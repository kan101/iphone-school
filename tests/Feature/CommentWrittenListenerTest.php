...
class CommentWrittenListenerTest extends TestCase
{
    ...
    public function it_creates_achievement_on_three_comments_written()
    {
        ...
        $this->create_prior_achievement($user, 'first_comment_written', 1, 'First Comment Written');
    ...
    public function it_creates_achievement_on_five_comments_written()
    {
        ...
        $this->create_prior_achievement($user, 'three_comments_written', 3, '3 Comments Written');
    ...
    public function it_creates_achievement_on_ten_comments_written()
    {
        ...
        $this->create_prior_achievement($user, 'five_comments_written', 5, '5 Comments Written');
    ...
    public function it_creates_achievement_on_twenty_comments_written()
    {
        ...
        $this->create_prior_achievement($user, 'ten_comments_written', 10, '10 Comments Written');
